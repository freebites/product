...
const ProgressBar = () => {
  ...
  const barStyle = (barProgress: SharedValue<number>) => {
    return useAnimatedStyle(() => {
      const backgroundColor = withTiming(
        interpolateColor(barProgress.value, [0, 1], ["green", "orange"]),
        config
      );
  ...
  const circleAnimation = (circleProgress: SharedValue<number>) => {
    return useAnimatedStyle(() => {
      return {
        transform: [
          {
            translateX: withTiming(
              interpolate(circleProgress.value, [0, 100], [-26, 0]),
              config
            ),
          },
        ],
  ...
  const style = (barProgress: number) =>
    useAnimatedStyle(() => {
      return {
  ...
  const nestedViewStyle = (
    ...
    circleProgress: (circleAnimationFinished: boolean) => void
  ) => {
    const onFinish = () => {
  ...
  return (
    <View style={styles.container}>
      <Animated.View style={[styles.barContainer]}>
        <Animated.View
          style={[styles.circle, { backgroundColor: COLORS.orange[70] }]}
        ></Animated.View>
        ...
        <View
          style={[
            styles.circle,
            {
              backgroundColor: circle1 ? COLORS.orange[70] : COLORS.green[20],
            },
          ]}
        ></View>
        <View style={styles.bar}>
        ...
        <View
          style={[
            styles.circle,
            {
              backgroundColor: circle2 ? COLORS.orange[70] : COLORS.green[20],
            },
          ]}
        ></View>
        <View style={styles.bar}>
        ...
        <View
          style={[
            styles.circle,
            {
              backgroundColor: circle3 ? COLORS.orange[70] : COLORS.green[20],
            },
          ]}
        ></View>
      </Animated.View>
